...
<section className="">
    <div className="container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12">
        <div className="wf-ull lg:w-1/2">
            ...
            <h1 className="mt-3 text-2xl font-semibold text-gray-800 dark:text-white md:text-3xl">{message}</h1>
            ...
            <div className="flex items-center mt-6 gap-x-3">
                ...
                <button className="w-1/2 bg-orange-400 text-white px-4 py-2 rounded-md hover:bg-orange-500 m-1">
                    <Link to={"/"}>
                    Take me home
                    </Link>
                </button>
